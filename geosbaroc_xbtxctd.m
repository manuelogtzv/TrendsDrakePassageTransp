...
cmap_sal = getPyPlot_cMap('gist_earth', length(cont_sal), [], pycmd);
cmap_temp = getPyPlot_cMap('seismic', length(cont_temp), [], pycmd);
cmap_vel = getPyPlot_cMap('coolwarm', length(cont_vel)-1, [], pycmd);
cmap_sterh = getPyPlot_cMap('gnuplot', length(cont_ster)-1, [], pycmd);
...
% loads transects
load('../XBT_XCTD_om/ax22om_1996_2019.mat');
