...
cmap1 = getPyPlot_cMap('seismic', length(cont1)-1);
cont2 = [-3.0:0.5:3];%vel contours
cmap2 = getPyPlot_cMap('seismic', length(cont2)-1);
cont3 = [-10:10];%vel contours
cmap3 = getPyPlot_cMap('seismic', length(cont3)-1);
