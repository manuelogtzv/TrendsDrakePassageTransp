function [trendfull confintfull sigtrend_ls trendfull_thse sigtrend_mk] = calctrends(data, time, alpha, season_opt);
...
% Inputs:
%
% + data: contains data in a matrix of size [N x M],
...
% + season_opt: option to remove seasonal cycle before calculating trends.
% 
% Outputs:
%
...
%
% 2022/07/18 - Option to remove seasonal cycle before calcuting trend
...
if nt~=nd
        ...
        sigtrend_ls = zeros(size(trendfull));
