function h = cbarrow(hcb, cm , options)
...
if makerightarrow
    cbpos = cbpos + [0 0 -cbpos(4)*arrow_l 0];
    cb.Position = cbpos; 
end
if makeleftarrow
    cbpos = cbpos + [cbpos(4)*arrow_l 0 -cbpos(4)*arrow_l 0];
    cb.Position = cbpos; 
end
if makeuparrow 
    cbpos = cbpos + [0 0 0 -cbpos(3)*arrow_l];
    cb.Position = cbpos; 
end
if makedownarrow 
    cbpos = cbpos + [0 cbpos(3)*arrow_l 0 -cbpos(3)*arrow_l];
    cb.Position = cbpos; 
end
...
if strcmpi(cb.Box,'on')
    ...
    if all([makerightarrow makeleftarrow])
        line(cbpos(1) +[0 cbpos(3) cbpos(3)+cbpos(4)*arrow_l cbpos(3) 0 -cbpos(4)*arrow_l 0],...
    ...
    if all([makerightarrow ~makeleftarrow])
        line(cbpos(1) +[0 cbpos(3) cbpos(3)+cbpos(4)*arrow_l cbpos(3) 0 0],...
    ...
    if all([~makerightarrow makeleftarrow])
        line(cbpos(1) +[0 cbpos(3) cbpos(3) 0 -cbpos(4)*arrow_l 0],...
    ...
    if all([makeuparrow makedownarrow])
        line(cbpos(1) +[0 0 cbpos(3)/2 cbpos(3) cbpos(3) cbpos(3)/2 0],...
            cbpos(2) + [0 cbpos(4) cbpos(4)+cbpos(3)*arrow_l cbpos(4) 0 -cbpos(3)*arrow_l 0],...
            'color',linecolor,'LineWidth',linewidth)
    end
    ...
    if all([makeuparrow ~makedownarrow])
        line(cbpos(1) +[0 0 cbpos(3)/2 cbpos(3) cbpos(3) 0],...
            cbpos(2) + [0 cbpos(4) cbpos(4)+cbpos(3)*arrow_l cbpos(4) 0 0],...
            'color',linecolor,'LineWidth',linewidth)
    end
    ...
    if all([~makeuparrow makedownarrow])
        line(cbpos(1) +[0 0 cbpos(3) cbpos(3) cbpos(3)/2 0],...
            cbpos(2) + [0 cbpos(4) cbpos(4) 0 -cbpos(3)*arrow_l 0],...
            'color',linecolor,'LineWidth',linewidth)
    end
end
%% Clean up: 
